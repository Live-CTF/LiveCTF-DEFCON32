...
int check_input(const char *input)
{
    ...
    check_digit_gt(input[0], 6)
for (int i = 0; i < 10; i++) { }
check_upper(input[1])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[2], "tXBZgLRhwvpICaGDoqNxFWzydHeOKMEAlUJnubrPmsYkfScjV")
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "IysXqjgvdDVwieTSfzmUCuxkAWrBHLKpYncoPGlhEQNJtMOZR")
for (int i = 0; i < 10; i++) { }
check_prime(input[4])
for (int i = 0; i < 10; i++) { }
check_digit(input[5])
for (int i = 0; i < 10; i++) { }
check_between(input[6], '2', '3')
for (int i = 0; i < 10; i++) { }
check_upper(input[7])
for (int i = 0; i < 10; i++) { }
