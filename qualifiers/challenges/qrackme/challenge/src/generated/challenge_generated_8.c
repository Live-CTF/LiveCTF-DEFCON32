...
int check_input(const char *input)
{
    ...
    check_upper(input[0])
for (int i = 0; i < 10; i++) { }
check_between(input[1], '0', '7')
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[2], "VhxjYeDlaHyLvMEFdNUnuPstbfqkCJizAWQXBoRwTmOKIGrpS")
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "MFzqRCnmTGrxoYhWDHjSsiyLdEuvNalcZktQPJKXIepVUgwfb")
for (int i = 0; i < 10; i++) { }
check_between(input[4], '5', '6')
for (int i = 0; i < 10; i++) { }
check_upper(input[5])
for (int i = 0; i < 10; i++) { }
check_digit(input[6])
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[7], 4)
for (int i = 0; i < 10; i++) { }
