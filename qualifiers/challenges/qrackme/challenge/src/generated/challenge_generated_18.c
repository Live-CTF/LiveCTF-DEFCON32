...
check_upper(input[2])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "VwzHoELRWSlZumgcGIfdAMBryxeOThNqkUQKJbaPjvCpiDsFX")
for (int i = 0; i < 10; i++) { }
check_prime(input[4])
for (int i = 0; i < 10; i++) { }
check_between(input[5], '6', '7')
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[6], "mAbBFzgWZwvnfRhUiqOEeCSlNptQKyjYITJrsVGXdLPoxMucH")
for (int i = 0; i < 10; i++) { }
