...
int check_input(const char *input)
{
    ...
    check_not_in_str(input[0], "UbhmNdnQCaTloLHMzuWtRSikswfePyrGIgBXcOJZVKEYADjpx")
for (int i = 0; i < 10; i++) { }
check_digit(input[1])
for (int i = 0; i < 10; i++) { }
check_lower(input[2])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "yoBShZUzbudeMNjLFnkvEHafDJCtiqsWGPKIOAgpRlVQxwcXY")
for (int i = 0; i < 10; i++) { }
check_between(input[4], '3', '7')
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[5], 7)
for (int i = 0; i < 10; i++) { }
check_digit(input[6])
for (int i = 0; i < 10; i++) { }
check_lower(input[7])
