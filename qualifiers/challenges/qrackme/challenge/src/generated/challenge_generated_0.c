...
check_digit(input[1])
for (int i = 0; i < 10; i++) { }
check_between(input[2], '5', '8')
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "RtKmikxYSqFvsUZLuOdVBojCwXafTbAPhNWzcIHlDQGnerMyE")
for (int i = 0; i < 10; i++) { }
check_prime(input[4])
for (int i = 0; i < 10; i++) { }
check_lower(input[5])
...
check_upper(input[6])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[7], "RiHeWZruOoEUTDqbCVkfSxQnPtmlMGLhjAIdYcXyKBzJwgpaF")
for (int i = 0; i < 10; i++) { }
