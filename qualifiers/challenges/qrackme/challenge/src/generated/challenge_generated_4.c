...
int check_input(const char *input)
{
    ...
    check_between(input[0], '3', '7')
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[1], 3)
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[2], 4)
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[3], 0)
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[4], 6)
for (int i = 0; i < 10; i++) { }
check_prime(input[5])
for (int i = 0; i < 10; i++) { }
check_upper(input[6])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[7], "fAiaBJtTCLHSWKFekpVcygnoulvGhZDOPbmsxMwQdUjYRzqEr")
for (int i = 0; i < 10; i++) { }
