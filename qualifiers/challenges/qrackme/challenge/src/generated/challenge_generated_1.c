...
int check_input(const char *input)
{
    ...
    check_upper(input[0])
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[1], 0)
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[2], 0)
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[3], "fYHBopkJNrKUwuqndtVjxZlLIhbMgyDvFReGEQmcTWCSAiXOP")
for (int i = 0; i < 10; i++) { }
check_lower(input[4])
for (int i = 0; i < 10; i++) { }
check_not_in_str(input[5], "dySNATFIJYoXkjBiracwDgzPKnuqWOxtHCGVbRelvEsUfZhQm")
for (int i = 0; i < 10; i++) { }
check_digit_gt(input[6], 8)
for (int i = 0; i < 10; i++) { }
check_prime(input[7])
for (int i = 0; i < 10; i++) { }
